...
export function CustomInput({ inProgress, onSend, onStop }: InputProps) {
  ...
  return (
    <div className="copilotKitInput">
      <div className="dailyLimit" data-state="normal" aria-live="polite">
        <span className="dailyLimit__label">Daily limit</span>
          <span className="dailyLimit__value">
            3 of 10 messages used today
          </span>
        </div>
      <textarea
        disabled={inProgress}
